...
import { Globe, FileText, TrendingUp, CheckCircle2, Clock, Zap, ArrowRight, Play, Sparkles } from 'lucide-react'
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-50 via-blue-50 to-indigo-50 p-6">
            <div className="max-w-7xl mx-auto">
                ...
                {/* Hero CTA - Pipeline */}
                <Card className="mb-8 border-2 border-indigo-300 bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 text-white shadow-xl">
                    <CardContent className="p-6">
                        <div className="flex items-center justify-between">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    <h2 className="text-2xl font-bold">Website-to-Content Pipeline</h2>
                                    <p className="text-indigo-100">
                                        Paste any URL → Analyze gaps → Generate topics → Create blogs
                                    </p>
                                </div>
                            </div>
