...
/**
 * Error Page for /app (Vendor Dashboard) Routes
 */
...
export default function AppError({
  ...
  useEffect(() => {
    ...
    if (process.env.NODE_ENV === 'production') {
      ...
      console.error('[App Error Report]', JSON.stringify(errorReport))
    }
  }, [error])
        ...
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-gray-600 mb-4">
              Something went wrong while loading the vendor dashboard. Please try again.
            </p>
