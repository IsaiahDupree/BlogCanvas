                ...
                <Card className="p-8 bg-white shadow-2xl">
                    ...
                    <div className="mt-6">
                        ...
                        <button
                            ...
                            className="mt-3 w-full px-6 py-3 bg-white border-2 border-gray-200 text-gray-700 rounded-lg font-medium hover:bg-gray-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                        >
